...
const edit_pet = function (e) {
  ...
  console.log(pet_edit[0]);
  console.log(p_index);
  // console.log(pet_edit[0].pet_age);
  pet_id.value = x.value;
  pet_age.value = pet_detail[p_index].pet_age;
  pet_type.value = pet_detail[p_index].pet_type;
  pet_weight.value = parseInt(pet_detail[p_index].pet_weight);
  pet_length.value = parseInt(pet_detail[p_index].pet_length);
  pet_color.value = pet_detail[p_index].pet_color;
  // pet_breed.value = pet_detail[p_index].pet_breed;
  console.log(pet_detail[p_index].vaccine);
  let vaccine1 = document.querySelector('.vaccined');
  if (pet_detail[p_index].vaccine != 'false') vaccine1.checked = true;
  else vaccine1.checked = false;
  let deworm1 = document.querySelector('.dewormed');
  if (pet_detail[p_index].deworm != 'false') deworm1.checked = true;
  else deworm1.checked = false;
  let sterillize1 = document.querySelector('.sterillized');
  if (pet_detail[p_index].sterillize != 'false') sterillize1.checked = true;
